...
INSERT INTO `itensvenda` VALUES (2,'001',5);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_venda` AFTER INSERT ON `itensvenda` FOR EACH ROW begin
	update produtos
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_delete` AFTER DELETE ON `itensvenda` FOR EACH ROW begin
	update produtos
...
INSERT INTO `produtos` VALUES ('001','Feijão',5),('002','Arroz',5),('003','Farinha',15);
...
-- Dump completed on 2020-11-18 13:37:56